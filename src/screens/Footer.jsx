        ...
        <footer className="footer-v4">
            <div className="container">
                ...
                <div className="footer-v4-main">
                    ...
                    {/* Middle: Signature (High Emphasis) */}
                    <div className="footer-v4-col signature-col">
                        <div className="footer-signature-wrap">
                            <img src="/signature.png" alt="Signature" className="main-signature-img" />
                            <div className="footer-reg-info-v4">
                                SEBI Reg. No. INH000022844
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="footer-v4-col social-col-v4">
                        ...
                        <div className="social-pills-v4">
                            {[
                                ...
                                <a key={index} href="#" className={social.className} onClick={(e) => e.preventDefault()}>
                ...
                <div className="footer-v4-legal">
                    | {[
                        ...
                        { to: "/general-disclaimer", label: "Disclaimer" }
                    ].map((link, index) => (
                    ...
                    {[
                        { href: "https://smartodr.in", label: "SMART ODR" },
                        { href: "https://scores.sebi.gov.in", label: "SCORES" }
                    ].map((link, index) => (
                        <React.Fragment key={index}>
